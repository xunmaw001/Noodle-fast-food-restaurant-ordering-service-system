            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">库存表管理</li>
                        <li class="breadcrumb-item active">库存表列表</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('name')">菜品名称</th>
                                    <th onclick="sort('number')">库存数量</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("kuchuen/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "kuchuen");
