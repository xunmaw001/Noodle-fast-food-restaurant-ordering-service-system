            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑菜品表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">菜品表信息</h3>
                            ...
                            <div class="form-row">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="money" name="money" class="form-control"
                                            onchange="moneyChickValue(this)" placeholder="菜品单价">
                                 </div>
                                   <div class="form-group col-md-6">
                                       <label>菜品图片</label>
...
<script>
    ...
    function initializationHxtypesSelect(){
        var hxTypesSelect = document.getElementById('hxTypesSelect');
            for (var i = 0; i < hxTypesOptions.length; i++) {
                hxTypesSelect.add(new Option(hxTypesOptions[i].name,hxTypesOptions[i].id));
            }
    }
    // 下拉框选项回显
    function setSelectOption() {
        for (var i = 0; i < hxTypesOptions.length; i++) {
            if(hxTypesOptions[i].id == ruleForm.hxTypes){//下拉框value对比,如果一致就赋值汉字
    ...
    function setContent() {
        if (ruleForm.shangpinContent != null && ruleForm.shangpinContent != 'null' && ruleForm.shangpinContent != '') {
            var mes = '' + ruleForm.shangpinContent;
    ...
    function getContent() {
        ...
        if (shangpinContentEditor.hasContents()) {
                $('#shangpinContent-input').attr('value', shangpinContentEditor.getPlainTxt());
        }
