    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑预定餐桌表</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">预定餐桌表管理</li>
                        <li class="breadcrumb-item active">编辑预定餐桌表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">预定餐桌表信息</h3>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yudingcanzhuo/info/" + id,
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("yudingcanzhuo/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("yudingcanzhuo/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
