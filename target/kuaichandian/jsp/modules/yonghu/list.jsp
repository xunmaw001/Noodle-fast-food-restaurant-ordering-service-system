            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">用户表管理</li>
                        <li class="breadcrumb-item active">用户表列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">用户表列表</h3>
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('name')">名称</th>
                                    <th onclick="sort('username')">账号</th>
                                    <th onclick="sort('password')">密码</th>
                                    <th>头像</th>
                                    <th onclick="sort('sexTypes')">性别</th>
                                    <th onclick="sort('phone')">手机号</th>
