            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">流水表登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>
                                        餐桌名称
                                        <input id="czTypesSelect" name="czTypesSelect" class="form-control"
                                        // v-model="ruleForm.czTypes" readonly
                                        >
                                    </label>
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    <label>
                                        是否支付
                                        <input id="sfTypesSelect" name="sfTypesSelect" class="form-control"
                                        // v-model="ruleForm.sfTypes" readonly
                                        >
                                    </label>
                                </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="maxMoney" name="maxMoney" class="form-control"
                                               v-model="ruleForm.maxMoney" readonly>
                                    </div>
...
<script>
    ...
    //查询当前页面下所有列表
        function czTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=cz_types", "GET", {}, (res) => {
                if(res.code == 0){
    ...
    function setSelectOption() {
        for (var i = 0; i < czTypesOptions.length; i++) {
            if(czTypesOptions[i].codeIndex == ruleForm.czTypes){//下拉框value对比,如果一致就赋值汉字
                var czTypesSelect = document.getElementById("czTypesSelect");
                    czTypesSelect.value = czTypesOptions[i].indexName;
            }
        }
        ...
        for (var i = 0; i < sfTypesOptions.length; i++) {
            if(sfTypesOptions[i].codeIndex == ruleForm.sfTypes){//下拉框value对比,如果一致就赋值汉字
                var sfTypesSelect = document.getElementById("sfTypesSelect");
                    sfTypesSelect.value = sfTypesOptions[i].indexName;
            }
        }
    }
