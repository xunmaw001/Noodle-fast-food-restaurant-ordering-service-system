            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">餐桌表列表</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('name')">餐桌名称</th>
                                    <th onclick="sort('sfTypes')">是否预定</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        var detailAttr = "subscribe(" + item.id + ')';
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("canzhuo/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function subscribe(id) {
        ...
        if (mymessage == true) {
            http("canzhuo/subscribe?ids="+id, "get", {}, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "canzhuo");
